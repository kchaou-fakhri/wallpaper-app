...
class ColorAdapter(val context: Context, val colors: ArrayList<com.dev0ko.ewelp.model.entity.Color>) : RecyclerView.Adapter<ColorAdapter.ViewHolder>() {

    inner class ViewHolder(viewItem : View) : RecyclerView.ViewHolder(viewItem) {


        fun bind(color : com.dev0ko.ewelp.model.entity.Color){
